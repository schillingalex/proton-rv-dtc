...
def load_or_train_model(task_dir: str, model: nn.Module, run_config: RunConfig, task_config: MLConfig,
    ...
    :param task_dir: The working directory to load the model from or save to after training.
